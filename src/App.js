    ...
    <div className="App" style={{marginLeft:"0px"}}>
      ...
      <div class = "div-box" style={{display: "flex"}}>
        <div class="div-1" style={{marginLeft: "0px", display: "flex", flexDirection: "row", flexWrap: "wrap", width: "66%"}}>
          {data.map((item, index) => ( // TODO: map puppyData to puppyData components
            <div style={{border: '5px solid red', width: "20vw", height: "30vw"}}>
                {PuppyItem(item[0])}
                <br></br>
                <button style = {{backgroundColor:"#E3E3E3", border:"3px solid blue", borderRadius:"2px", fontSize: "1vw"}} onClick={() => {handleInc(item)}}>Add to Family</button>
            </div>
          ))}
        </div>
        <div>
        <div style={{border: '5px solid red', borderRadius: "2px", width: "20vw", height: "37vw", fontSize: "1vw"}}>
          ...
          <div>
            <button style = {{backgroundColor:"#E3E3E3", border:"3px solid blue", borderRadius:"2px", fontSize: "1vw"}} onClick={() => {Clearer()}}>Clear</button>
          </div>
        </div>
      </div>
    </div>
